    ...
    <div class="container" ref="containerRef">
      <div>
        ...
        >
          ...
          <!-- Render button side by side with the chat message -->
          <div v-if="role == 'system' || role == 'assistant'">
            <button @click="postResponse(content)">Hey</button>
          </div>
        </q-chat-message>
      </div>
      <!-- Waiting for AI -->
      ...
      >
        <div>
          ...
          <q-btn flat @click="moveOn()">go on!</q-btn>
        </div>
      </q-chat-message>
    </div>
...
const roleToAvatarLink = {
  user: 'https://i.ibb.co/cxVJf22/logo.jpg',
  system: 'https://i.ibb.co/RPwPXcj/logo1.png',
  assistant: 'https://i.ibb.co/mrjSFkt/logo-3.jpg',
};
